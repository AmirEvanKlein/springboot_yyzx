	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
				...
				<el-form-item label="充值号" prop="recharge_number">
							  ...
							  v-if="user_group === '管理员' || (form['recharge_information_id'] && $check_field('set','recharge_number')) || (!form['recharge_information_id'] && $check_field('add','recharge_number'))" :disabled="true"></el-input>
				...
				<el-form-item label="普通用户" prop="ordinary_users">
													<el-select v-if="user_group === '管理员' || (form['recharge_information_id'] && $check_field('set','ordinary_users')) || (!form['recharge_information_id'] && $check_field('add','ordinary_users'))" id="ordinary_users" v-model="form['ordinary_users']" :disabled="disabledObj['ordinary_users_isDisabled']">
				...
				<el-form-item label="充值金额" prop="recharge_amount">
						...
						v-if="user_group === '管理员' || (form['recharge_information_id'] && $check_field('set','recharge_amount')) || (!form['recharge_information_id'] && $check_field('add','recharge_amount'))" :disabled="disabledObj['recharge_amount_isDisabled']"></el-input-number>
				...
				<el-form-item label="充值日期" prop="recharge_date">
								<el-date-picker :disabled="disabledObj['recharge_date_isDisabled']" v-if="user_group === '管理员' || (form['recharge_information_id'] && $check_field('set','recharge_date')) || (!form['recharge_information_id'] && $check_field('add','recharge_date'))" id="recharge_date"
