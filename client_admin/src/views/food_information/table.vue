<template>
	<el-main class="bg table_wrap">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/food_information/table','set') || $check_action('/food_information/view','set') || $check_action('/food_information/view','get') || $check_action('/下单购买/table','add') || $check_action('/下单购买/view','add')" >
