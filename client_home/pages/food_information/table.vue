<template>
  <view class="page_food_information diy_table diy_table_tml" id="food_information_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="美食名称" name="food_name">
                      <uni-easyinput type="text" v-model="query.food_name" placeholder="美食名称" />
                    </uni-forms-item>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/food_information/view?" v-show="user_group == '管理员' || $check_action('/food_information/table','add') || $check_action('/food_information/view','add')">添加</navigator>
	...
	<view class="warp" >
		<view class="container">
			<view v-for="(o,i) in list" class="row box_style">
									<view class="col" v-if="1 && $check_field('get','food_name')">
						<view class="view">
						...
						<view class="view">
							<view class="diy_title" v-if=" false">
								<span>封面</span>
									...
									<view class="col" v-if="1 && $check_field('get','food_unit_price')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>美食单价</span>
							</view>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','food_materials')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>美食材料</span>
							</view>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>详情介绍</span>
									...
									<rich-text v-html="o['details']"></rich-text>
								</view>
													</view>
					</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/food_information/table','del') || $check_action('/food_information/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/food_information/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/food_information/table','set') || $check_action('/food_information/view','set') || $check_action('/food_information/view','get')" class="btn btn-primary">详情</navigator>
																							<!--跨表按钮-->
															<a type="button" size="mini" class="btn btn-primary" v-if="$check_action('/food_order/view','add')" @click="to_form('/pages/food_order/view',o)">
									<span>下单购买</span>
								</a>
																						</view>
			</view>
