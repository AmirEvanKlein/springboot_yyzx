<template>
	<view class="page_swimming_hall_information diy_detail diy_detail--new" id="swimming_hall_information_details">
		<view class="warp">
			<view class="container-fluid">
				<view class="row">
					<view v-if="$check_field('get','no_of_swimming_pool')" class="col-12 col-6">
						<view class="view">
					...
					<view v-if="$check_field('get','name_of_swimming_pool')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>泳馆名称</span>
							</view>
					...
					<view v-if="$check_field('get','location_of_swimming_pool')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>泳馆位置</span>
							</view>
					...
					<view v-if="$check_field('get','capacity')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>容纳人数</span>
							</view>
					...
					<view v-if="$check_field('get','reservation_unit_price')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>预约单价</span>
							</view>
					...
					<view v-if="$check_field('get','details_of_swimming_pool')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>泳馆详情</span>
							</view>
								<view class="diy_field diy_html" v-html="obj['details_of_swimming_pool']" >
							</view>
							</view>
					</view>
				</view>
	...
	<div class='warp' v-if='timeTypeShow'>
		...
		<view class="warp">
			<view class="container-fluid container-fluid-comment--new">
				<view class="row">
					<view class="col">
									<button type="button" class="btn btn-primary" v-if="$check_action('/venue_reservation/edit','add')" @click="to_form('/pages/venue_reservation/edit')">
							<span>预约</span>
						</button>
...
<!--						<button type="button" class="btn btn-primary" @click="cancel()">返回</button>-->
						...
						<navigator class="btn link"
							:url="'/pages/comment/edit?source_table=swimming_hall_information&source_field=swimming_hall_information_id&source_id=' + obj['swimming_hall_information_id']">
							评论
						</navigator>
	...
	export default {
		...
		methods: {
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "swimming_hall_information",
					source_field: "swimming_hall_information_id",
					source_id: obj["swimming_hall_information_id"],
					user_id
				};
			...
			change_collect() {
				...
				var query = {
					source_table: "swimming_hall_information",
					source_field: "swimming_hall_information_id",
					source_id: this.obj["swimming_hall_information_id"],
					user_id
				};
				...
				if (this.state_collect) {
					...
					this.state_collect = true;
													query.title = this.obj.name_of_swimming_pool
