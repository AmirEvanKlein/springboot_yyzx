<template>
	<view class="page_swimming_hall_information diy_list diy_list_page div_list_tml" id="swimming_hall_information_list">
		<!-- 筛选模块(开始) -->
		<view>
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
														<uni-search-bar placeholder="搜索泳馆名称" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'name_of_swimming_pool')">
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?swimming_hall_information_id=' + o['swimming_hall_information_id']" class="btn btn-primary">查看详情</navigator>
...
<script>
	...
	created() {
		...
		var url_get_list = "~/api/swimming_hall_information/get_list?timing_start_time_max=" + oNowDate +
