<template>
  <view id="home" class="home--new">
    ...
    <Card
      class="list_diy"
      title="泳馆信息推荐"
      url="/pages/swimming_hall_information/list"
      :list="list_article"
      v-if="$check_action('/swimming_hall_information/list', 'get')"
    >
	  <list_swimming_hall_information :list="list_swimming_hall_information"></list_swimming_hall_information>
    ...
    <Card
      class="list_diy"
      title="美食信息推荐"
      url="/pages/food_information/list"
      :list="list_article"
      v-if="$check_action('/food_information/list', 'get')"
    >
	  <list_food_information :list="list_food_information"></list_food_information>
...
<script>
		...
		import list_swimming_hall_information from "@/components/diy/list_swimming_hall_information.vue";
  ...
  methods: {
    ...
    toToggle() {
      this.isAdmin = !this.isAdmin;
		...
		*  获取泳馆信息
		*/
		get_swimming_hall_information() {
			let url = "~/api/swimming_hall_information/get_list?";
							var oNowDate = this.dateFormat("yyyy-MM-dd hh:mm:ss") + "";
				var url_get_list =
				"~/api/swimming_hall_information/get_list?timing_start_time_max=" +
				oNowDate +
				"&timing_end_time_min=" +
				oNowDate +
				"&like=0";
			...
			this.$get(url, {
					...
					this.list_swimming_hall_information = json.result.list;
									}
			});
		},
    								/**
		...
		get_food_information() {
			...
			this.$get(url, {
					...
					this.list_food_information = json.result.list;
											this.list_food_information.map((o)=>{
							o["praise_len"];
						});
						this.get_praise(this.list_food_information ,"food_information" ,"15931");
									}
			});
		},
