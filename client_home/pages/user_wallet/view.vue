          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','ordinary_users') || $check_field('add','ordinary_users') || $check_field('set','ordinary_users')" label="普通用户" name="ordinary_users">
                  ...
                  v-if="user_group === '管理员' || (form['user_wallet_id'] && $check_field('set','ordinary_users')) || (!form['user_wallet_id'] && $check_field('add','ordinary_users'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['ordinary_users']"
                  :localdata="list_user_ordinary_users"
              ...
              <uni-forms-item v-if="$check_field('get','wallet_amount') || $check_field('add','wallet_amount') || $check_field('set','wallet_amount')" label="钱包金额" name="wallet_amount">
                                <uni-easyinput type="text" v-model="form['wallet_amount']" v-if="user_group === '管理员' || (form['user_wallet_id'] && $check_field('set','wallet_amount')) || (!form['user_wallet_id'] && $check_field('add','wallet_amount'))" :disabled="disabledObj['wallet_amount_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','wallet_amount')">
                  {{ form['wallet_amount'] }}
                </text>
                            </uni-forms-item>
