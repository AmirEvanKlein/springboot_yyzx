<template>
  <view class="page_food_order diy_table diy_table_tml" id="food_order_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/food_order/view?" v-show="user_group == '管理员' || $check_action('/food_order/table','add') || $check_action('/food_order/view','add')">添加</navigator>
                          ...
                          <view class="diy_title" v-if=" false">
                            <span>封面</span>
								...
								<img :src="$fullUrl(o['cover'])" />
													...
													<view v-if="1 && $check_field('get','food_unit_price')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>美食单价</span>
                          </view>
								...
								<text>
									{{ o['food_unit_price'] }}
													...
													<view v-if="1 && $check_field('get','flavor')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>口味</span>
                          </view>
								...
								<text>
									{{ o["flavor"] }}
													...
													<view v-if="0 && $check_field('get','food_materials')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>美食材料</span>
                          </view>
                            ...
                            <span>普通用户</span>
								...
								<text>
									{{ get_user_ordinary_users(o['ordinary_users']) }}
													...
													<view v-if="0 && $check_field('get','purchase_quantity')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>购买数量</span>
                          </view>
								...
								<text>
									{{ o['purchase_quantity'] }}
													...
													<view v-if="0 && $check_field('get','payment_amount')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>支付金额</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/food_order/table','del') || $check_action('/food_order/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/food_order/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/food_order/table','set') || $check_action('/food_order/view','set') || $check_action('/food_order/view','get')" class="btn btn-primary">详情</navigator>
	                					</view>
				</view>
			</view>
		</view>
