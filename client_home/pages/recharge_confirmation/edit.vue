<template>
	<view class="diy_edit page_recharge_confirmation" id="recharge_confirmation_edit">
		<view class='warp'>
			<view class='container'>
				<view class='row'>
						...
						<view class="diy_title diy_text_row">
							...
							<input type="text" id="form_recharge_number" v-model="form['recharge_number']" placeholder="请输入充值号" v-if="(form['recharge_number'] && $check_field('set','recharge_number')) || (!form['recharge_number'] && $check_field('add','recharge_number'))" :disabled="disabledObj['recharge_number_isDisabled']" />
