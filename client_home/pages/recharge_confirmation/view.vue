          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','recharge_number') || $check_field('add','recharge_number') || $check_field('set','recharge_number')" label="充值号" name="recharge_number">
                                <uni-easyinput type="text" v-model="form['recharge_number']" v-if="user_group === '管理员' || (form['recharge_confirmation_id'] && $check_field('set','recharge_number')) || (!form['recharge_confirmation_id'] && $check_field('add','recharge_number'))" :disabled="disabledObj['recharge_number_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','ordinary_users') || $check_field('add','ordinary_users') || $check_field('set','ordinary_users')" label="普通用户" name="ordinary_users">
                  ...
                  v-if="user_group === '管理员' || (form['recharge_confirmation_id'] && $check_field('set','ordinary_users')) || (!form['recharge_confirmation_id'] && $check_field('add','ordinary_users'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['ordinary_users']"
                  :localdata="list_user_ordinary_users"
              ...
              <uni-forms-item v-if="$check_field('get','recharge_amount') || $check_field('add','recharge_amount') || $check_field('set','recharge_amount')" label="充值金额" name="recharge_amount">
                                <uni-easyinput type="text" v-model="form['recharge_amount']" v-if="user_group === '管理员' || (form['recharge_confirmation_id'] && $check_field('set','recharge_amount')) || (!form['recharge_confirmation_id'] && $check_field('add','recharge_amount'))" :disabled="disabledObj['recharge_amount_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','recharge_date') || $check_field('add','recharge_date') || $check_field('set','recharge_date')" label="充值日期" name="recharge_date">
                        <uni-datetime-picker v-if="user_group === '管理员' || (form['recharge_confirmation_id'] && $check_field('set','recharge_date')) || (!form['recharge_confirmation_id'] && $check_field('add','recharge_date'))" v-model="form['recharge_date']" type="date" :disabled="disabledObj['recharge_date_isDisabled']" />
                <!-- 仅查看 -->
