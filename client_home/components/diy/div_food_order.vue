<template>
	<view class="diy_details diy_div_food_order">
...
<script>
	...
	export default {
		...
		methods: {
			...
			async get_obj_by_id(){
				var res = await this.$get("~/api/food_order/get_obj", {
					food_order_id:this.query.food_order_id
				})
		...
		async onLoad(){
			...
			} else if (this.query["food_order_id"] !==0) {
